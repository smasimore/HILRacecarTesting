...
/**************OS_Init***************
Description: Initialize operating system. Initialize OS controlled I/O: serial, 
  ADC, systick, LaunchPad I/O and timers 
Inputs: none
Outputs: ErrorCode
*/
...
Description: Disables Timer5. Must have periodic thread added first.
Inputs: none
Outputs: ErrorCode
*/
...
Description: Clears timer's counter.
Inputs: none
Outputs: none
*/
...
/**************OS_ReadPeriodicTime***************
Description: Returns timer's counter value.
Inputs: none
Outputs: Timer's counter value
*/
...
unsigned long OS_AddThread(void(*task)(void), 
